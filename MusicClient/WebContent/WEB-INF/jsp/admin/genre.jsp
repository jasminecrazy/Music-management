...
<body data-ng-app="myApp" class="nav-md" data-ng-controller="genreCtrl">
								...
								<div class="modal-content">
									...
									<div class="modal-body row">
										<form class="form-horizontal" name="frmFormAdd"
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													<label class=" control-label" for="">Genre Name</label>
													<div class="">
														<input id="genreName" name="genreName"
															class="form-control input-md" type="text"
															ng-model="add_genreName" ng-required="true" />
									...
									<div class="modal-footer">
										<button id="btnSave" name="btnSave" class="btn btn-primary"
											ng-disabled="frmFormAdd.genreId.$error.required ||frmFormAdd.genreName.$error.required"
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title" id="myModalLabel">Edit genre
											information</h4>
									</div>
									<div class="modal-body row">
										<form class="form-horizontal" name="editForm">
											<div class="col-md-6">
												<div class="form-group">
													<label class=" control-label" for="">Genre ID</label>
													<div class="">
														<input id="genreId" name="genreId"
															ng-keyup="hideDuplicateAlert()"
															class="form-control input-md" type="text" readonly = "true"
															ng-model="edit_genreId" ng-required="true" />
														<div ng-messages="editForm.genreId.$error">
															<div ng-message="required"
																ng-show="editForm.genreId.$touched">
																<p style="color: red">This field is required</p>
															</div>
														</div>
													</div>
												...
												<div class="form-group">
													...
													<div class="">
														<input id="genreName" name="genreName"
															class="form-control input-md" type="text"
															ng-model="edit_genreName" ng-required="true" />
														<div ng-messages="editForm.genreName.$error">
															<div ng-message="required"
																ng-show="editForm.genreName.$touched">
																<p style="color: red">This field is required</p>
															</div>
														</div>
													</div>
									...
									<div class="modal-footer">
										...
										<button id="btnSave" name="btnSave" class="btn btn-primary"
											ng-disabled="editForm.genreId.$error.required ||editForm.genreName.$error.required"
						...
						<div class="modal fade" id="myModal_delete" tabindex="-1"
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<a class="btn btn-danger btn-ok" ng-click="deleteGenres()">Yes</a>
										<button type="button" class="btn btn-default"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/assets/scripts/genreCtrl.js"></script>
