											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<div class="">
														...
														<span style="color: red" ng-show="frmUserAdd.email.$error.email">
												...
												<div class="form-group">
													...
													<div class="">
														<input id="phone" name="phone"
															class="form-control input-md" type="text"
															ng-model="add_phone" ng-required="true" />
														<div ng-messages="frmUserAdd.phone.$error">
															<div ng-message="required"
																ng-show="frmUserAdd.phone.$touched">
																<p style="color: red">This field is required</p>
															</div>
														</div>
														<p ng-show="duplicateAlert != ''" ng-bind="duplicateAlert"
												...
												<div class="form-group">
													...
													<div class="">
														<input id="username" name="username"
															...
															ng-keydown="autoAdd($event)" type="text" readonly="true"
												...
												<div class="form-group">
													...
													<div class="">
														<input id="phone" name="phone"
															...
															class="form-control input-md"
															ng-keydown="autoAdd($event)" type="text"
															ng-model="edit_phone" ng-required="true" />
														<div ng-messages="editForm.phone.$error">
															<div ng-message="required"
																ng-show="editForm.phone.$touched">
																<p style="color: red">This field is required</p>
															</div>
														</div>
													</div>
									...
									<div class="modal-body row">
										<form class="form-horizontal" name="frmReset">
											...
											<input type="hidden" ng-model="reset_id_role" /> <input
												...
												type="hidden" ng-model="reset_status" /> <input
												type="hidden" ng-model="reset_email" /> <input type="hidden"
												ng-model="reset_employeeId" />
