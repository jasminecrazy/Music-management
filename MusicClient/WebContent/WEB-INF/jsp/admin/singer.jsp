...
<body data-ng-app="myApp" class="nav-md" data-ng-controller="singerCtrl">
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title" id="myModalLabel">Add new singer</h4>
									</div>
									<div class="modal-body row">
										<form class="form-horizontal" name="frmFormAdd"
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													<label class=" control-label" for="">Singer Name</label>
													<div class="">
														<input id="singerName" name="singerName"
															class="form-control input-md" type="text"
															ng-model="add_singerName" ng-required="true" />
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title" id="myModalLabel">Edit singer
											information</h4>
									</div>
									<div class="modal-body row">
										<form class="form-horizontal" name="editForm">
											<div class="col-md-6">
												<div class="form-group">
													<label class=" control-label" for="">Singer ID</label>
													<div class="">
														<input id="singerId" name="singerId"
															ng-keyup="hideDuplicateAlert()"
															class="form-control input-md" type="text" readonly = "true"
															ng-model="edit_singerId" ng-required="true" />
														<div ng-messages="editForm.singerId.$error">
															<div ng-message="required"
																ng-show="editForm.singerId.$touched">
																<p style="color: red">This field is required</p>
															</div>
														</div>
													</div>
												...
												<div class="form-group">
													...
													<div class="">
														<input id="singerName" name="singerName"
															class="form-control input-md" type="text"
															ng-model="edit_singerName" ng-required="true" />
									...
									<div class="modal-footer">
										...
										<button id="btnSave" name="btnSave" class="btn btn-primary"
											ng-disabled="editForm.singerId.$error.required ||editForm.singerName.$error.required"
						...
						<div class="modal fade" id="myModal_delete" tabindex="-1"
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<a class="btn btn-danger btn-ok" ng-click="deleteSingers()">Yes</a>
										<button type="button" class="btn btn-default"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/assets/scripts/singerCtrl.js"></script>
