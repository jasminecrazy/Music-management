...
<body data-ng-app="myApp" class="nav-md" data-ng-controller="authorCtrl">
								...
								<div class="modal-content">
												...
												<div class="form-group">
													...
													<div class="">
														<input id="authorName" name="authorName"
															...
															ng-model="add_authorName" ng-required="true" />
									...
									<div class="modal-footer">
										<button id="btnSave" name="btnSave" class="btn btn-primary"
											ng-disabled="frmFormAdd.authorId.$error.required ||frmFormAdd.authorName.$error.required"
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title" id="myModalLabel">Edit author
											information</h4>
									</div>
									<div class="modal-body row">
										<form class="form-horizontal" name="editForm">
											<div class="col-md-6">
												<div class="form-group">
													<label class=" control-label" for="">Author ID</label>
													<div class="">
														<input id="authorId" name="authorId"
															ng-keyup="hideDuplicateAlert()"
															class="form-control input-md" type="text" readonly="true"
															ng-model="edit_authorId" ng-required="true" />
														<div ng-messages="editForm.authorId.$error">
															<div ng-message="required"
																ng-show="editForm.authorId.$touched">
																<p style="color: red">This field is required</p>
															</div>
														</div>
													</div>
												...
												<div class="form-group">
													...
													<div class="">
														<input id="authorName" name="authorName"
															class="form-control input-md" type="text"
															ng-model="edit_authorName" ng-required="true" />
														<div ng-messages="editForm.authorName.$error">
															<div ng-message="required"
																ng-show="editForm.authorName.$touched">
																<p style="color: red">This field is required</p>
															</div>
														</div>
													</div>
									...
									<div class="modal-footer">
										...
										<button id="btnSave" name="btnSave" class="btn btn-primary"
											ng-disabled="editForm.authorId.$error.required ||editForm.authorName.$error.required"
						...
						<div class="modal fade" id="myModal_delete" tabindex="-1"
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<a class="btn btn-danger btn-ok" ng-click="deleteAuthors()">Yes</a>
										<button type="button" class="btn btn-default"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/assets/scripts/authorCtrl.js"></script>
