	...
	<div class="music-left">
		...
		<div class="">
			<div class="tittle-head">
				<h3 class="tittle">List Song</h3>

				<div class="clearfix"></div>
			</div>
			<div class="col-md-3 content-grid" data-ng-repeat="x in list_song" data-ng-show="showList(x,$index)">
			...
			<div class="clearfix"></div>
			<div class='w3-center'>
		<uib-pagination data-total-items="list_song.length"
